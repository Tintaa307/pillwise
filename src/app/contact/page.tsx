    ...
    <main className="w-full h-screen flex items-center justify-center flex-col bg-primary_blue">
      ...
      <div className="w-full h-[72%] flex items-center justify-start flex-col bg-white rounded-t-3xl">
        ...
        <form
          ...
          autoComplete="off"
          className="w-full h-max flex items-center justify-center flex-col gap-6 mt-6 mb-10"
        >
          ...
          <button className="w-[85%] h-14 rounded-md outline-none border-none bg-primary_blue text-white text-lg font-normal mb-10">
            Enviar
          </button>
        </form>
      </div>
